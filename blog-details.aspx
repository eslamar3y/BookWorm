<%@ Page Title="" Language="C#" MasterPageFile="~/M.Master" AutoEventWireup="true" CodeBehind="blog-details.aspx.cs" Inherits="back_end_project.blog_details" %>
            ...
            <div class="blog__sidebar">
              <div class="blog__sidebar__search">
                <form method="post" action="#">
                    <input type="text" placeholder="Search..." name="Blog_Search" />
                    <button type="submit">
