                ...
                <div class="latest-product__text">
                  ...
                  <div class="latest-product__slider owl-carousel">
                    <div class="latest-prdouct__slider__item">
                      ...
                      <ItemTemplate>
                      <a href="shop-details.aspx?id=<%# Eval("id") %>" class="latest-product__item">
                        <div class="latest-product__item__pic">
                          <img src="img/product/<%# Eval("img") %>" alt="" />
                        </div>
            ...
            <asp:Repeater ID="Repeater1" runat="server">
                ...
                <div class="col-lg-4">
                    ...
                    <div class="product__discount__item__text">
                        ...
                        <h5><a href="shop-details.aspx?id=<%# Eval("id") %>"><%# Eval("title") %></a></h5> <!-- name -->
              ...
              <div class="row">
                <div class="col-lg-4 col-md-5">
                  <div class="filter__sort">
                    <span>Sort By</span>
                      <!-- Categories -->
                    <select id="justpost" onchange="postpls()">
                      <option value="ALL">Default</option>
            <asp:Repeater ID="Repeater2" runat="server">
                <ItemTemplate>
                    <option name="category" value="<%# Eval("CatName") %>"><%# Eval("CatName") %></option>
                </ItemTemplate>
            </asp:Repeater>
                    </select>
                  </div>
              ...
              <div class="col-lg-4 col-md-6 col-sm-6 prod">
                <div class="product__item">
                  ...
                  <div class="product__item__text">
                    <h6><a href="shop-details.aspx?id=<%# Eval("id") %>"><%# Eval("ntitle") %> . . .</a></h6><!-- Name -->
    ...
    <script>
        function postpls() {
            ...
            if (!string.includes("?search=")) {
                ...
                let result = string.indexOf("?search=");
